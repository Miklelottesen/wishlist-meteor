...
Create a new file called `wishes-list.component.ts` and put it in `client/imports/app/parties` directory.

[{]: <helper> (diff_step 6.1)
#### Step 6.1: Create PartiesList component

##### Added client/imports/app/parties/wishes-list.component.ts
```diff
@@ -0,0 +1,23 @@
...
##### Added client/imports/app/parties/wish-details.component.ts
```diff
@@ -0,0 +1,9 @@
+┊ ┊1┊import { Component } from '@angular/core';
+┊ ┊2┊
